...
import 'package:grabber/features/categories/repository/category_repository.dart';
import 'package:grabber/features/product/model/product_model.dart';
import 'package:grabber/features/product/repo/product_repository.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                TextButton(
                  onPressed: () {
                    ...
                    if (selectedSort != null) {
                      context.read<ProductsCubit>().setSortOption(
                        selectedSort!,
                      );
                    }
                    Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    final cartItemCount = context.select<CartCubit, int>(
      (cubit) => cubit.state.cart.length,
    );
    List<String> slider = [
          ...
          child: Column(
            children: [
              ...
              BlocBuilder<CartCubit, CartState>(
                builder: (context, state) {
                  return AddToCartBar(cart: state.cart);
                },
              ),
            ],
          ),
